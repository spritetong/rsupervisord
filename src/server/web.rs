...
/// Service handler for embedded static asset serving and Single Page Application fallback.
pub struct WebAssetHandler;

impl WebAssetHandler {
    /// Dispatches an incoming URI to the matching embedded static file or index.html SPA fallback.
    pub fn handle(uri: &axum::http::Uri) -> Response {
